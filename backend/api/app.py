...
def _build_router():
    ...
    @r.post("/books/{book_id}/payment-methods/reorder")
    ...
    @r.put("/books/{book_id}/invoices/{invoice_id}")
    def update_invoice(book_id: str, invoice_id: int, body: sc.CreateInvoiceReq, request: Request):
        return fac(request).h_update_invoice(
